...
const Admin = () => {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        // Fetch total posts
        const postsResponse = await fetch('https://myblogbackend-fk9u.onrender.com/totalposts');
        const postsData = await postsResponse.json();
        setTotalPosts(postsData.total);

        // Fetch total contacts
        const contactsResponse = await fetch('https://myblogbackend-fk9u.onrender.com/totalcontacts');
