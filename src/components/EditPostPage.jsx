...
const EditPostPage = () => {
  ...
  useEffect(() => {
    ...
    const fetchPost = async () => {
      try {
        const response = await fetch(`https://myblogbackend-fk9u.onrender.com/getposts/${id}`);
        const data = await response.json();
        setPost(data);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(`https://myblogbackend-fk9u.onrender.com/updatepost/${id}`, {
        method: 'PUT',
        headers: {
